function getData_RecordList() {
	...
	*/
    ...
    arrRecordList = [
		...
		[0, "Career Scoring Avg (Gross)", "Minimum 3 Events", 2310, "record.html?g=0&c=0&e=0&sb=0&se=" + (arrSeasons.length - 1) + "&r=", 5, 3],
		[0, "Career Scoring Avg (Net)", "Minimum 3 Events", 2310, "record.html?g=0&c=0&e=0&sb=0&se=" + (arrSeasons.length - 1) + "&r=", 6, 3],
