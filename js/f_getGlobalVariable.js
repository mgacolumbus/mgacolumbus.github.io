function getGlobalVariable(VariableName) {
	...
	switch (pVariable)
	{
		...
		case 'Navigation_LinkRules':				return 'rules.html';
		...
		case 'Navigation_TitleRules':				return 'Chapter Rules';
		
		case 'Page_BodyClass':						return 'w3-sand';//'w3-light-grey';
		...
		case 'Page_RulesIcon':						return 'fa-list-alt';
		case 'Page_RulesIconColor':					return 'black';
		case 'Page_RulesTitle':					return 'Chapter Rules';
