function html_CategoryButtons(pCategory, pType) {
    ...
    for (x = 0; x < arrData.length; x++) {
        ...
        if (arrData[x][0] == vCategory) {
            ...
            if (vType == "Category") {
                document.write("    <a href='" + arrData[x][4] + "' style='text-decoration: none; font-weight: bold;'>");
            } else if (vType == "Record") {
                document.write("    <a href='" + arrData[x][4] + x + "' style='text-decoration: none; font-weight: bold;'>");
            }
