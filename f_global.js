...
function getFullRoundScore(RoundArray, RoundIndex, IsNet) {
	var pRound	=	arguments[0];	var pRoundIndex	=	arguments[1];
...
function calcScore(RoundArray, RoundIndex, NumOfHoles, HoleOffset, IsNet) {
	var pRound	=	arguments[0];		var pRoundIndex	=	arguments[1];		var pNumOfHoles	=	arguments[2];
	var pOffset	=	arguments[3];		var pIsNet		=	arguments[4];
	
	var x = 0;	var vScoreTotal = 0;
